...
namespace butterBror.Utils
{
    ...
    public class CAFUS
    {
        ...
        private static readonly (double Version, Action<string, PlatformsEnum> Action)[] _migrations =
        {
            (1.0, Migrate0),
            (1.1, Migrate1),
            (1.2, Migrate2),
        ...
        public void Maintrance(string userId, string username, PlatformsEnum platform)
        {
        ...
        private static void Migrate0(string uid, PlatformsEnum p)
        {
            Engine.Statistics.FunctionsUsed.Add();
        ...
        private static void Migrate1(string uid, PlatformsEnum p)
        {
            Engine.Statistics.FunctionsUsed.Add();
        ...
        private static void Migrate2(string uid, PlatformsEnum p)
        {
            Engine.Statistics.FunctionsUsed.Add();
        ...
        private static void Migrate3(string uid, PlatformsEnum p)
        {
            Engine.Statistics.FunctionsUsed.Add();
            var defaults = new Dictionary<string, object>
            {
        ...
        private static void Migrate4(string uid, PlatformsEnum p)
        {
            Engine.Statistics.FunctionsUsed.Add();
        ...
        private static void SaveIfMissing(string uid, string key, object value, PlatformsEnum p)
        {
            Engine.Statistics.FunctionsUsed.Add();
        ...
        private static void SaveDefaults(string uid, PlatformsEnum p, Dictionary<string, object> defaults)
        {
