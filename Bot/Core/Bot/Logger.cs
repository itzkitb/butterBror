...
namespace bb.Core.Bot
{
    ...
    public class Logger
    {
            ...
            [CallerMemberName] string memberName = "")
        {
            ...
            System.Console.WriteLine($"{"[".Pastel("#bababa")} {GetEmoji(type)} {DateTime.Now.ToString("HH:mm.ss").PadRight(8).Pastel("#888888")} {"]".Pastel("#bababa")} {$"{fileName}:{lineNumber}".Pastel(Program.MainColor)} {"-".Pastel("#bababa")} {message.Pastel("#bababa")}");
