...
namespace bb.Core.Commands.List.Fun
{
    public class Tuck : CommandBase
    {
        ...
        public override string Source => "Fun/Tuck.cs";
        ...
        public override string Help => "<name> [text]";
        ...
        public override CommandReturn Execute(CommandData data)
        {
            ...
            try
            {
                if (data.ChannelId == null || Program.BotInstance.DataBase == null || Program.BotInstance.TwitchName == null)
                {
                ...
                if (data.Arguments != null && data.Arguments.Count >= 1)
                {
                    ...
                    {
                        if (userID != null)
                            isSelectedUserIsNotIgnored = (Roles)DataConversion.ToInt(Program.BotInstance.UsersBuffer.GetParameter(data.Platform, DataConversion.ToLong(data.User.Id), Users.Role)) > Roles.Bot;
                    }
                    catch (Exception) { }
                    if (username.ToLower() == Program.BotInstance.TwitchName.ToLower())
                    {
