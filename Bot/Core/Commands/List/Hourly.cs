    ...
    public class Hourly : CommandBase
    {
        ...
        public override CommandReturn Execute(CommandData data)
        {
            ...
            try
            {
                ...
                {
                    bb.Program.BotInstance.Currency.Add(data.User.Id, hourPriceBTR, data.Platform);
                    ...
                    string message = LocalizationService.GetString(data.User.Language, "command:hourly:get", data.ChannelId, data.Platform, hourPriceBTR);
