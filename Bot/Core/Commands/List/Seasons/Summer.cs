...
namespace bb.Core.Commands.List.Seasons
{
    public class Summer : CommandBase
    {
        ...
        public override string Source => "Seasons/Summer.cs";
        public override Dictionary<Language, string> Description => new() {
            { Language.RuRu, "Узнать, сколько времени осталось до начала/конца лета." },
            { Language.EnUs, "Find out how much time is left until the beginning/end of summer." }
        };
