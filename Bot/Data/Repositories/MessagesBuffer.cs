...
namespace bb.Data.Repositories
{
    ...
    public class MessagesBuffer : IDisposable
    {
        ...
        private readonly MessagesRepository _db;
        ...
        /// </remarks>
        public MessagesBuffer(MessagesRepository db)
        {
            _db = db;
        ...
        /// <item>Delegates actual database storage to <see cref="MessagesRepository.SaveMessages"/></item>
